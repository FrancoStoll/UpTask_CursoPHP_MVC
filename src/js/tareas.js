(function () {
  ...
  function mostrarTareas() {
    ...
    arrayTareas.forEach((tarea) => {
      ...
      // Crear un elemento span para el símbolo de editar
      const iconoEditar = document.createElement("span");
      iconoEditar.innerHTML = "&#x270E;"; // Utilizando el código hexadecimal

      // Agregar el símbolo de editar al inicio del contenido del elemento p
      nombreTarea.appendChild(iconoEditar);
  ...
  function mostrarFormulario(editar = false, tarea = {}) {
    ...
    modal.innerHTML = `
        ...
        name="tarea"
        placeholder="${
          tarea.nombre ? "Editar la Tarea" : "Añadir Tarea al Proyecto Actual"
        }"
        id="tarea"
        ...
        <div class="opciones">
        <input
        type="submit" class="submit-nueva-tarea"
  ...
  async function actualizarTarea(tarea) {
    ...
    // Para poder ver los valores antes de enviaros
  ...
  async function eliminarTarea(tarea) {
    ...
    try {
      ...
      if (resultado.resultado) {
        ...
        Swal.fire("Elimnado", resultado.mensaje, "success");
